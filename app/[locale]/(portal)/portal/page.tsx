      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-start justify-between mb-4">
            ...
            <svg className="w-5 h-5 text-secondary-400 group-hover:text-primary-500 group-hover:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          </div>
          <h3 className="text-secondary-600 text-sm font-medium mb-1">Active Leads</h3>
          <p className="text-4xl font-bold text-secondary-900 mb-3">{leadsTotal}</p>
        ...
        >
          ...
          <h3 className="text-secondary-600 text-sm font-medium mb-1">Pending Estimates</h3>
          <p className="text-4xl font-bold text-secondary-900 mb-3">{estimatesTotal}</p>
        ...
        >
          ...
          <h3 className="text-secondary-600 text-sm font-medium mb-1">Invoiced Jobs</h3>
          <p className="text-4xl font-bold text-secondary-900 mb-3">{invoicedTotal}</p>
          <div className="space-y-1 text-sm text-secondary-500">
            <div className="flex items-center gap-2">
        ...
        {/* Completed Card */}
        <Link
          href={`/${locale}/portal/leads?status=complete`}
          className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all group"
        >
          <div className="flex items-start justify-between mb-4">
          ...
          <h3 className="text-secondary-600 text-sm font-medium mb-1">Completed Jobs</h3>
          <p className="text-4xl font-bold text-secondary-900 mb-3">{completedTotal}</p>
          <div className="text-sm text-secondary-500">
            <div className="flex items-center gap-2">
