...
const projects: BeforeAfterProject[] = [
  ...
  },
  {
    ...
    before: '/GalleryImages/7-before.jpg',
    after: '/GalleryImages/7-after-BM-Solid-KendallCharcoal(HC-166).JPG',
  },
  {
    id: 8,
  ...
  },
  {
    ...
    before: '/GalleryImages/14-before.JPG',
    after: '/GalleryImages/14-after-Steina-LightOak.JPG',
  },
  {
    id: 15,
    titleKey: 'bmCordovanBrown',
    before: '/GalleryImages/15-before.JPG',
    after: '/GalleryImages/15-after-BM-Solid-CordovanBrown(ES-62).JPG',
  },
  {
    id: 16,
    titleKey: 'lignaGoldenPine4',
    before: '/GalleryImages/16-before.JPG',
    after: '/GalleryImages/16-after-Ligna-GoldenPine.jpg',
  },
  {
    id: 17,
    titleKey: 'lignaPaprika',
    before: '/GalleryImages/17-before.jpg',
    after: '/GalleryImages/17-after-Ligna-Paprika.jpg',
  },
  {
    id: 18,
    titleKey: 'bmPlatinumGray',
    before: '/GalleryImages/18-before.JPG',
    after: '/GalleryImages/18-after-BM-Solid-PlatinumGray(HC-179).JPG',
  },
  {
    id: 19,
    titleKey: 'bmNaturalCedartone3',
    before: '/GalleryImages/19-before.jpeg',
    after: '/GalleryImages/19-after-BM-Semi-NaturalCedartone.jpeg',
  },
  {
    id: 20,
    titleKey: 'penofinIPEOil',
    before: '/GalleryImages/20-before.JPG',
    after: '/GalleryImages/20-after-Penofin-IPEOil.JPG',
  },
  {
    id: 21,
    titleKey: 'bmTudorBrown1',
    before: '/GalleryImages/21-before.JPG',
    after: '/GalleryImages/21-after-BM-Solid-TudorBrown(HC-185).JPG',
  },
  {
    id: 22,
    titleKey: 'steinaLightOak4',
    before: '/GalleryImages/22-before.JPG',
    after: '/GalleryImages/22-after-Steina-LightOak.JPG',
  },
  {
    id: 23,
    titleKey: 'lignaGoldenPine5',
    before: '/GalleryImages/23-before.JPG',
    after: '/GalleryImages/23-after-Ligna-GoldenPine.JPG',
  },
  {
    id: 24,
    titleKey: 'bmTudorBrown2',
    before: '/GalleryImages/24-before.JPG',
    after: '/GalleryImages/24-after-BM-Solid-TudorBrown(HC-185).JPG',
  },
  {
    id: 25,
    titleKey: 'lignaGoldenPine6',
    before: '/GalleryImages/25-before.jpg',
    after: '/GalleryImages/25-after-Ligna-GoldenPine.JPG',
  },
]
