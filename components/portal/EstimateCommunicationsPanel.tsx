...
interface EstimateCommunicationsPanelProps {
  estimate: Estimate
...
export function EstimateCommunicationsPanel({
  estimate,
  timeline,
  isLoading,
  onBack,
}: EstimateCommunicationsPanelProps) {
  ...
  const { stage, context: stageContext, isLoading: isStageLoading } = useCustomerStage(estimate.customer?.id || null)
  ...
  const customer: Customer | null = estimate.customer
    ? {
        ...
        address: null,
        language: estimate.customer.language,
        internal_notes: null,
        access_token: estimate.customer.access_token || '',
        created_at: '',
        updated_at: '',
      }
    : null
