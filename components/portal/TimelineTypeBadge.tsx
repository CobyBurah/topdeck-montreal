...
import type { TimelineItemType } from '@/types/communication'
...
export function TimelineTypeBadge({ type, label, className }: TimelineTypeBadgeProps) {
  return (
    <span
      className={cn(
...
function TypeIcon({ type }: { type: TimelineItemType }) {
